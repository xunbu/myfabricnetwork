module guolong.com/fabric-restful-api

go 1.24.4

replace guolong.com/fabric-gateway => ../../gateway/mygateway

replace guolong.com/basic-chaincode => ../../chaincode/basicChainCode
...
require (
	...
	guolong.com/fabric-gateway v0.0.0-00010101000000-000000000000
)
...
require (
	...
	guolong.com/basic-chaincode v0.0.0-00010101000000-000000000000 // indirect
)
